...
class IsEditorPatch : ModMenuButtonToggle
{
    ...
    protected override void OnEnable()
    {
        if(isEditorHook == null){
            PluginLC.Logger.LogInfo("isEditorHook is null!");
            return;
        }
        isEditorHook.Apply();
    }
    ...
    private static bool Override_Application_isEditor(Func<bool> orig){
        PluginLC.Logger.LogInfo("I was called!");
        orig();
        return true;
    }
}
...
{
    readonly ModMenuItemMetadata meta = new("Movement Cheat");
    public override ModMenuItemMetadata Metadata => meta;
...
{
    readonly ModMenuItemMetadata meta = new("On Death: Heal");
    public override ModMenuItemMetadata Metadata => meta;
...
{
    readonly ModMenuItemMetadata meta = new("Infinite Credits");
    public override ModMenuItemMetadata Metadata => meta;
...
{
    readonly ModMenuItemMetadata meta = new("Infinite Shotgun Ammo");
    public override ModMenuItemMetadata Metadata => meta;
